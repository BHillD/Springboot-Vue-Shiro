  ...
  <div>
    <el-container>
      <el-header style="display: flex;justify-content: space-between;align-items: center;padding-left: 0px">
        ...
        <el-button size="mini" type="success" @click="loadSalary" icon="el-icon-refresh"></el-button>
      </el-header>
    ...
    <div style="text-align: left">
      <el-dialog
        ...
        <div style="display: flex;align-items: center;justify-content: center;padding: 0px;margin: 0px;">
          ...
          <el-button type="primary" round size="mini" @click="next" v-text="index==6?'完成':'下一步'"></el-button>
        </div>
      </el-dialog>
    </div>
  </div>
